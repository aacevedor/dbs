...
var HttpInfoService = (function () {
    function HttpInfoService(_http) {
        this._http = _http;
        this.JsonTest = "http://blaa.demodayscript.com/api/node.json";
    }
    HttpInfoService.prototype.getJsonTest = function () {
        this._http.get(this.JsonTest).map(function (res) { return res.json(); });
        return this._http.get(this.JsonTest).map(function (res) { return res.json(); });
    };
